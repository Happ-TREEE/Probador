...
def editar_producto(id_producto):
    ...
    id_tela = request.form['id_tela']
    imagen_file = request.files.get('imagen')

    controlador_producto.actualizar_producto(id_producto, nombre, descripcion, precio, notas, id_categoria, id_tela, imagen_file)
...
def crear_producto():
    ...
    controlador_producto.insertar_producto(nombre, descripcion, precio, notas, id_categoria, id_tela, imagen_file)
    return redirect('/gestionar_producto')
