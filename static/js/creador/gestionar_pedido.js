function cargarPedido(btn) {
  ...
  // Asignar fecha_registro directamente (ya en formato 'yyyy-mm-dd')
...
var confirmDeletePedidoModal = document.getElementById('confirmDeleteModalPedido');
if (confirmDeletePedidoModal) {
  confirmDeletePedidoModal.addEventListener('show.bs.modal', function(event) {
